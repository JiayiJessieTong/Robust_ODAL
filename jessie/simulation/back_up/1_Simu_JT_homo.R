...
### setting two (K = seq(2,92,by = 10), seqeach n = 1000, total N changes with K)
##################################################
...
# assign the column names to the result data frame
...
save.image("/Users/Jessie/Desktop/000_UPenn_Research/000_project/000_ODAL/R_code/jessie/simulation/1_homo.Rdata")
