...
compare.methods = function(Xall, Yall, site){
  ...
  hessian_mat <- function(beta){
    ...
    for (i in 1:K){
      ...
      L[i,] = Lgradient(beta,Xsite,Ysite)
  ...
  var1_mean = hessian_mat(ODAL1_mean)
  var1_median = hessian_mat(ODAL1_median)
  var2_mean = hessian_mat(ODAL2_mean)
  var2_median = hessian_mat(ODAL2_median)
  ...
  ####Variance: return the heissian matrix####
  meta_var1_mean = hessian_mat(meta_ODAL1_mean)
  meta_var1_median = hessian_mat(meta_ODAL1_median)
  meta_var2_mean = hessian_mat(meta_ODAL2_mean)
  meta_var2_median = hessian_mat(meta_ODAL2_median)
  ...
  output = list(beta_local = beta0,
                beta_pooled = betaall,
                beta_meta = betameta,
                ODAL1_mean = ODAL1_mean,
                ODAL1_median = ODAL1_median,
                ODAL2_mean = ODAL2_mean,
                ODAL2_median = ODAL2_median,
                var_matrix_local = as.vector(v_beta0),
                var_matrix_pooled = as.vector(v_betaall),
                var_meta = vmeta,
                hessian_local_ODAL1_mean = var1_mean,
                hessian_local_ODAL2_median = var1_median,
                hessian_local_ODAL1_mean = var2_mean,
                hessian_meta_ODAL2_median = var2_median,
                hessian_meta_ODAL1_mean = meta_var1_mean,
                hessian_meta_ODAL2_median = meta_var1_median,
                hessian_meta_ODAL1_mean = meta_var2_mean,
                hessian_meta_ODAL2_median = meta_var2_median)
